...
const HanhKhach = {
    ...
    insert:(data,callback)=>{
        return conn.query(`INSERT INTO hanhkhach(Ten,Sdt,Email,TrangThai) 
        VALUES ('${data.Ten}' , '${data.Sdt}' , '${data.Email}', '${data.TrangThai}')`,callback);
    },

    update:(data,callback)=>{
        return conn.query(`UPDATE hanhkhach SET Ten = '${data.Ten}' ,Sdt = '${data.Sdt}',Email = '${data.Email}, 
